...
def get_skeleton_frame_from_msg(msg):
    ...
    frame["Timestamp"] = msg.id * 1/30 * 1e6
    # frame["Timestamp"] = 0
    ...
    #   joint_pos_local += np.array(pelvis_pos) / 100
...
if __name__ == "__main__":
    ...
    urdf_path = "../human-model-generator/code/models/humanModels/male.urdf"

    # print(os.stat(urdf_path))
