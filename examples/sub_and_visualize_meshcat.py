...
if __name__ == "__main__":
    ...
    # urdf_path = "/home/s/repos/human-gazebo/humanSubjectWithMeshes/humanSubjectWithMesh.urdf"
    ...
    def lcm_skeleton_handler(channel, data):
        ...
        for task, target in targets.items():
            ...
            if (task == "PELVIS"):
                print("task", task, "target", target.translation)
